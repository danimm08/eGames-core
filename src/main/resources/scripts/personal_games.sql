...
INSERT INTO personal_game (description, number_of_views, type, game_id, user_id, exchange_id) VALUES ("Lo compré, pero apenas juego, por eso lo quiero cambiar por otro",0,"Fijo", 310, 5,NULL);
INSERT INTO personal_game (description, number_of_views, type, game_id, user_id, exchange_id) VALUES ("Creía que iba a ser de otra forma, y no me gusta a pesar de que es un juegazo",0,"Fijo", 315, 5,1);
INSERT INTO personal_game (description, number_of_views, type, game_id, user_id, exchange_id) VALUES ("Ya compré el NBA 2K17, así que lo cambiaría por otro tipo de juego.",0,"Fijo", 326, 6,3);
INSERT INTO personal_game (description, number_of_views, type, game_id, user_id, exchange_id) VALUES ("Este juego me venía con la play, ya lo pasé y lo quiero cambiar",0,"Fijo", 572, 6,4);
