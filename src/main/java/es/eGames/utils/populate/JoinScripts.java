...
public class JoinScripts {
    public static void main(String[] args) throws IOException {
        String root = "/home/daniel/Proyectos/eGamesProject/eGames/src/main/resources/scripts/";
//        String[] files = {"platform.sql", "game_mode.sql", "genre.sql", "keyword.sql", "game.sql", "game_game_modes.sql", "game_genres.sql", "game_keywords.sql"};
        ...
        File fileToSave = new File("/home/daniel/Proyectos/eGamesProject/eGames/src/main/resources/import.sql");
